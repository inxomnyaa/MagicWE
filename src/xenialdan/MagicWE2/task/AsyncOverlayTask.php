...
class AsyncOverlayTask extends MWEAsyncTask
{
     ...
     * @throws \Exception
     */
    public function __construct(Selection $selection, UUID $sessionUUID, array $chunks, array $filterBlocks, array $newBlocks, int $flags)
    {
     ...
     * @throws \Exception
     */
    private function editBlocks(Selection $selection, AsyncChunkManager $manager, array $filterBlocks, array $newBlocks): int
    {
        ...
        $lastprogress = 0;
        /** @var Block $block */
        foreach ($selection->getHighestBlockLayer($manager, $filterBlocks, $this->flags) as $block) {
